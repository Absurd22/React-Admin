...
const Basic: FC = () => {
  ...
  return (
    <PageContainer>
      <Card bordered={false}>
        <Descriptions title="订单申请" style={{ marginBottom: 32 }}>
          <Descriptions.Item label="订单编号">1000000000</Descriptions.Item>
          <Descriptions.Item label="状态">待安排</Descriptions.Item>
          <Descriptions.Item label="销售单号">1234123421</Descriptions.Item>
        </Descriptions>
        <Divider style={{ marginBottom: 32 }} />
        <Descriptions title="用户信息" style={{ marginBottom: 32 }}>
          <Descriptions.Item label="用户姓名">付小小</Descriptions.Item>
          <Descriptions.Item label="联系微信">youjia123456</Descriptions.Item>
          <Descriptions.Item label="联系电话">18100000000</Descriptions.Item>
          <Descriptions.Item label="联系邮箱">12345678@126.com</Descriptions.Item>
          <Descriptions.Item label="备注">无</Descriptions.Item>
        </Descriptions>
        <Divider style={{ marginBottom: 32 }} />
        <div className={styles.title}>最新订单</div>
        <ProTable
